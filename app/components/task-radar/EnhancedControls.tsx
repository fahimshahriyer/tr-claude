...
export function EnhancedControls() {
  ...
  useKeyboardShortcuts(
    ...
    () => {} // Edit task removed - double-click task to view details
  );
    ...
    <>
      ...
      <div className="absolute top-4 right-4 z-50 flex flex-col gap-1.5">
        ...
        <button
          ...
          className="w-8 h-8 flex items-center justify-center bg-zinc-600 hover:bg-zinc-700 text-white rounded transition-colors"
        ...
        {/* Zoom Controls */}
        <div className="bg-gray-900/90 backdrop-blur-sm border border-gray-700 rounded p-1 flex flex-col gap-0.5">
          <button
            onClick={handleZoomIn}
            disabled={zoom >= CONSTANTS.MAX_ZOOM}
            className="w-8 h-8 flex items-center justify-center rounded hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed text-zinc-400 text-sm font-bold transition-colors"
            title="Zoom in (+)"
          >
            +
          </button>
        ...
        {/* Feature Toggles */}
        <div className="bg-gray-900/90 backdrop-blur-sm border border-gray-700 rounded p-1 flex flex-col gap-1">
          {/* Dependency Mode */}
          <button
            onClick={
          ...
          <button
            onClick={resetView}
            className="w-8 h-8 flex items-center justify-center hover:bg-gray-800 text-gray-400 rounded transition-all"
            title="Reset view (R)"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
        ...
        <div className="bg-gray-900/90 backdrop-blur-sm border border-gray-700 rounded p-1 flex flex-col gap-1">
          ...
          <button
            ...
            className="w-8 h-8 flex items-center justify-center bg-red-900/30 hover:bg-red-900/50 text-red-400 rounded transition-all"
